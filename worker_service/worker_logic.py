# worker_logic.py
from firestore_utils import jobs_update
from replicate_jobs import generate_nano_banana

def run_nano_banana_job(job_id: str, media: dict, prompt: str):
    jobs_update(job_id, {"status": "running"})
    try:
        ...
        jobs_update(job_id, payload)
    
    except Exception as e:
        jobs_update(job_id, {"status": "failed", "error": repr(e)})
